...
{return (function() { 
var G__9387__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
var args = cljs.core.seq(arglist__9388);
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3634__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3634__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__9390 = res;(G__9390[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__9390;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9391){var vec__9393 = p__9391;var id = cljs.core.nth.call(null,vec__9393,(0),null);var class$ = cljs.core.nth.call(null,vec__9393,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_9394 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_9394 === "key")))
{(o[pname_9394] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__9397 = jsprops;(G__9397["defaultValue"] = value);
(G__9397["value"] = null);
(G__9397["onChange"] = ((function (G__9397,on_change,value){
return (function (p1__9395_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9395_SHARP_);
});})(G__9397,on_change,value))
);
return G__9397;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__9403 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__9403,(0),null);var id = cljs.core.nth.call(null,vec__9403,(1),null);var class$ = cljs.core.nth.call(null,vec__9403,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3634__auto__ = id;if(cljs.core.truth_(or__3634__auto__))
{return or__3634__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__9405 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__9405,(0),null);var id_class = cljs.core.nth.call(null,vec__9405,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj9409 = {};(obj9409[reagent.impl.util.cljs_argv] = v);
(obj9409[reagent.impl.util.cljs_level] = level);
return obj9409;
})();var k_9410 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__9411 = (((k_9410 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9410);if((k_SINGLEQUOTE__9411 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__9411);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4490__auto___9412 = a.length;var i_9413 = (0);while(true){
if((i_9413 < n__4490__auto___9412))
{(a[i_9413] = reagent.impl.template.as_component.call(null,(a[i_9413]),level_SINGLEQUOTE_));
{
var G__9414 = (i_9413 + (1));
i_9413 = G__9414;
continue;
}
} else
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4490__auto___9415 = a.length;var i_9416 = (0);while(true){
if((i_9416 < n__4490__auto___9415))
{if((i_9416 >= first_child))
{(a[i_9416] = reagent.impl.template.as_component.call(null,(a[i_9416]),level));
} else
{}
{
