...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj11158 = {};return obj11158;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3536__auto__ = this$;if(and__3536__auto__)
...
{var x__4175__auto__ = (((this$ == null))?null:this$);return (function (){var or__3548__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4175__auto__)]);if(or__3548__auto__)
{return or__3548__auto__;
} else
{var or__3548__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3548__auto____$1)
...
return (function (p__11159){var vec__11160 = p__11159;var k = cljs.core.nth.call(null,vec__11160,(0),null);var v = cljs.core.nth.call(null,vec__11160,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__11161){var vec__11162 = p__11161;var k = cljs.core.nth.call(null,vec__11162,(0),null);var v = cljs.core.nth.call(null,vec__11162,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
