...
{return (function() { 
var G__7018__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
var G__7018 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__7018__delegate.call(this,args);};
G__7018.cljs$lang$maxFixedArity = 0;
G__7018.cljs$lang$applyTo = (function (arglist__7019){
var args = cljs.core.seq(arglist__7019);
return G__7018__delegate(args);
});
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3548__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3548__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__7021 = res;(G__7021[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__7021;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__7022){var vec__7024 = p__7022;var id = cljs.core.nth.call(null,vec__7024,(0),null);var class$ = cljs.core.nth.call(null,vec__7024,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_7025 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_7025 === "key")))
{(o[pname_7025] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__7028 = jsprops;(G__7028["defaultValue"] = value);
(G__7028["value"] = null);
(G__7028["onChange"] = ((function (G__7028,on_change,value){
return (function (p1__7026_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__7026_SHARP_);
});})(G__7028,on_change,value))
);
return G__7028;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__7034 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__7034,(0),null);var id = cljs.core.nth.call(null,vec__7034,(1),null);var class$ = cljs.core.nth.call(null,vec__7034,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3548__auto__ = id;if(cljs.core.truth_(or__3548__auto__))
{return or__3548__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__7036 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__7036,(0),null);var id_class = cljs.core.nth.call(null,vec__7036,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj7040 = {};(obj7040[reagent.impl.util.cljs_argv] = v);
(obj7040[reagent.impl.util.cljs_level] = level);
return obj7040;
})();var k_7041 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__7042 = (((k_7041 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_7041);if((k_SINGLEQUOTE__7042 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__7042);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4404__auto___7043 = a.length;var i_7044 = (0);while(true){
if((i_7044 < n__4404__auto___7043))
{(a[i_7044] = reagent.impl.template.as_component.call(null,(a[i_7044]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4404__auto___7046 = a.length;var i_7047 = (0);while(true){
if((i_7047 < n__4404__auto___7046))
{if((i_7047 >= first_child))
{(a[i_7047] = reagent.impl.template.as_component.call(null,(a[i_7047]),level));
} else
{}
{
var G__7048 = (i_7047 + (1));
i_7047 = G__7048;
continue;
}
} else
